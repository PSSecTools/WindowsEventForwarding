<#
	.SYNOPSIS
		Installs the WindowsEventForwarding Module from github
		
	.DESCRIPTION
		This script installs the WindowsEventForwarding Module from github.
