function Disable-WEFSubscription {
    <#
        ...
        .DESCRIPTION
            Disable Windows Eventlog Forwarding subscription(s)
        ...
        .EXAMPLE
            PS C:\> Disable-WEFSubscription -Name "Subscription1"

            Disable the subscription "Subscription1"

        .EXAMPLE
            PS C:\> Get-WEFSubscription -Name "Subscription1" | Disable-WEFSubscription

            Disable "Subscription1" by using the pipeline.
    ...
    begin {
        try {
            ...
            $scriptCmd = {& $wrappedCmd -Enabled $false @PSBoundParameters }
