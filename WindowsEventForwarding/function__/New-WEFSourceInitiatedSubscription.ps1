function New-WEFSourceInitiatedSubscription {
    <#
        ...
        .DESCRIPTION
            Create a new Windows Eventlog Forwarding subscription(s) from type SourceInitiated.
        ...
        .EXAMPLE
            PS C:\> New-WEFSubscription -Name "MySubscription" -LogFile "ForwardedEvents" -Query '<Select Path="Security">*[System[(Level=1 )]]</Select>' -SourceDomainComputer "Domain computers"
    ...
    begin
    {
        try {
            ...
            $scriptCmd = {& $wrappedCmd -Type "SourceInitiated" @PSBoundParameters }
