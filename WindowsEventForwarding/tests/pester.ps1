...
Remove-Module WindowsEventForwarding -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\WindowsEventForwarding.psd1"
Import-Module "$PSScriptRoot\..\WindowsEventForwarding.psm1" -Force
